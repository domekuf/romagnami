                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2 text-center">
                        ...
                        <p class="text-faded">
                            ...
                            $_GET['t'] = 'ChiSiamo';
                            include('testi/testiController.php');
...
<?php
include('prodotti/prodottiController.php')
?>
    <!--aside class="bg-dark">
...
$('.portfolio-box').on('click', function(){
    $('#bodyDetail').html($(this).next('div.htmlContent').html());
    $('#titleDetail').html($(this).data('title'));
